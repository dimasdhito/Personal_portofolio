      ...
      items: [
        {
          ...
          github: 'https://github.com/dimasdhito/Personal_portofolio',
          demo: 'https://dimasdhito-portfolio.netlify.app'
        },
        {
          id: 2,
          name: 'Netflix Landing Page Clone',
          imageUrl: 'netflix',
          status: 'A clone of Netflix.com landing page. Built with HTML, CSS and JS',
          tech: 'HTML, CSS, Javascript',
          github: 'https://github.com/dimasdhito/netflix-landing-page',
          demo: 'https://dimasdhito-netlix-landingpage.netlify.app'
        },
        {
          id: 3,
          name: 'Fibonacci Calculator WebApp',
          imageUrl: 'fibonacci',
          status: 'A WebApp that can give a fibonacci sequences.',
          tech: 'HTML, CSS, Javascript',
          github: 'https://github.com/dimasdhito/fibonacci-app/tree/main/fibonacci-app',
          demo: 'https://dimasdhito-fibonacci-app.netlify.app'
        },
        {
          id: 4,
          name: 'Resto Bakaran Company Profile Website',
          imageUrl: 'restobakaran',
          status: 'A Company Profile Website for a restaurant called Resto Bakaran.',
          tech: 'HTML, CSS',
          github: 'null',
          demo: 'null'
        }
