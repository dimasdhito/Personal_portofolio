    ...
    <nav class="max-w-7xl px-5 md:fixed top-0 z-[98] w-screen backdrop-blur-md bg-[#121212] bg-opacity-80">
      <div class="container mx-auto flex flex-wrap items-center justify-between">
        <button @click="redirectToHome" class="flex">
          <span
            class="self-center text-lg text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-blue-500 font-semibold whitespace-nowrap fadein-bot hover:text-blue-500">dimasPramudhito();</span>
        </button>
        <div class="flex md:order-2 fadein-bot">
          <a href="https://github.com/dimasdhito"><img class="w-9 rounded-full"
