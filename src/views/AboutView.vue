    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 5,
          name: 'Python',
          imageUrl: 'https://img.icons8.com/color/48/python--v2.png',
          status: 'Beginner'
        },
        {
          id: 6,
      ...
      tools: [
        ...
        },
        {
          id: 5,
          name: 'FL Studio',
          imageUrl: 'https://img.icons8.com/color/48/fl-studio.png',
          status: 'Music Production'
        },
        {
          id: 6,
          name: 'Microsoft Office',
          imageUrl: 'https://img.icons8.com/color/48/microsoft-office-2019.png',
          status: 'Documents'
        },
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="rounded-full border-2 border-blue-200 glass mb-3 fadein-up" src="~\src/assets/Foto_Dimas.png"
            width="50%" alt="Foto">
        </div>
        <div class="md:w-8/10">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Dimas Pramudhito. I'm a web developer from Bogor, West Java.
            I love everything that i do at the moment. Either that's coding, design or music production.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My goal is to keep learning new things. No matter how smart or experienced i will be,
            even in the future.
            I hope that i can keep growing as a programmer, graphic designer, music producer or as a person. And i
            also hope that i can keep making a web product that is useful for the mass and the world. Feel free to click
            my email below to reach out to me if you're interested in working with me. <a
              href="https://mail.google.com/mail/?view=cm&fs=1&to=dimaspramudhito@gmail.com">dimaspramudhito@gmail.com</a>.
          </p>
        </div>
...
.glass {
  background: linear-gradient(135deg, rgba(73, 127, 255, 0.1), rgba(73, 127, 255, 0));
