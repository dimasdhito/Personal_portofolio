<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Dimas Pramudhito</h1>
      <div class="py-2">
        <h1
    ...
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300"
        height="300" decoding="async" data-nimg="1" class="w-8/10 md:h-auto rounded-full border-4 border-blue-200 pict"
        src="~\src/assets/Foto_Dimas.png">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Web Developer", "UI/UX Designer", "Informatics 2023 Fresh-Grad", "Tech Enthusiast", "Music Producer"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
...
.pict {
  box-shadow: 0px 0px 73px -9px rgba(73, 127, 255, 0.44);
  -webkit-box-shadow: 0px 0px 73px -9px rgba(73, 127, 255, 0.44);
  -moz-box-shadow: 0px 0px 73px -9px rgba(73, 127, 255, 0.44);
}
